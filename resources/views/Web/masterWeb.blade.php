...
<div id="container">
  ...
  <nav class="cyan z-depth-2">
    <div class="nav-wrapper">
      <a href="/Web" class="brand-logo"><i class="material-icons">school</i> Web Dashboard</a>
    ...
    <ul id="slide-out" class="side-nav fixed z-depth-5">
      ...
      <li class="no-padding">
        <ul class="collapsible collapsible-accordion">
          <li>
            <a class="collapsible-header waves-effect waves-cyan">Profil Web<i class="material-icons cyan-text">arrow_right</i></a>
            <ul class="collapsible-body no-padding">
              <li><a href="#">Slider<i class="material-icons tiny">list</i></a></li>
              <li><a href="#">Slider<i class="material-icons tiny">add</i></a></li>            
            </ul>
          </li>
        </ul>
      </li>
